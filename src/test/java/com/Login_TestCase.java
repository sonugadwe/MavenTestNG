...
*/
	public static Logger log = Logger.getLogger(Login_TestCase.class);
	@BeforeSuite(groups = "Smoke")
	public static WebDriver setup_Browser() {
		System.setProperty("webdriver.chrome.driver", "F:\\FULL TIME\\Selenium Task\\MavenTestNG\\chromedriver.exe");
	...
	public static void Verify_Url() {
		...
		// expected url
		String expected_url = "file:///F:/Selenium%20Software/Offline%20Website/Offline%20Website/index.html";
	...
	public static void Verify_Url_DashBoard() {
		...
		// expected url
		String expected_url = "file:///F:/Selenium%20Software/Offline%20Website/Offline%20Website/pages/examples/dashboard.html";
		Assert.assertEquals(my_url, expected_url);
	...
	public void heading_Dashboard() throws InterruptedException {
		String stitle = driver.findElement(
				By.xpath("//h1[contains(text(),'Dashboard1')]")).getText();
